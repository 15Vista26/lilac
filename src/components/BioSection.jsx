        ...
        <section className="bg-cream px-6 py-20">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-2 md:order-1 flex flex-col items-start gap-8">
                    <h2 className="text-5xl md:text-6xl font-serif text-green-900">
                        Hi, I'm Lilac.
                    </h2>
                    <div className="text-lg md:text-xl text-green-900 font-sans space-y-6 leading-relaxed">
                        <p>
                    ...
                    <Link
                        href="/contact"
                        className="inline-block px-8 py-4 border border-green-900 text-green-900 font-sans text-sm tracking-widest hover:bg-green-900 hover:text-cream transition-colors uppercase mt-4"
                    >
                        Let's Chat →
                    </Link>
                </div>
                ...
                <div className="order-1 md:order-2 relative w-full aspect-[4/5] md:aspect-[3/4]">
                    ...
                    <div className="absolute -bottom-12 -left-12 w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-8 border-cream z-10">
